...
namespace meltrix {
    ...
    /// \brief Constructor for a random matrix with default parameters for the chosen distribution.
    ...
    /// \brief Constructor for a random matrix with user-defined parameters for the chosen distribution.
    /// \param rows Number of rows in the matrix.
    /// \param cols Number of columns in the matrix.
    /// \param type Type of distribution to use.
    /// \param param1 First parameter for the distribution.
    /// \param param2 Second parameter for the distribution.
